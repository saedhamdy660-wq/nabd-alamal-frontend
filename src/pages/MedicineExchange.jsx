...
const categoryColors = {
  "الأورام": {
    background: "#e4f9f4",
    iconBackground: "#d1f4ec",
  },

  "الضغط والقلب": {
    background: "#eaf8f6",
    iconBackground: "#d8f3ee",
  },

  "السكري": {
    background: "#eef9f7",
    iconBackground: "#ddf4ef",
  },
  ...
  "البرد والحساسية": {
    background: "#eefaf8",
    iconBackground: "#dff5f0",
  },

  "مسكنات": {
    background: "#eef9f7",
    iconBackground: "#d9f3ee",
  },

  "المضادات الحيوية": {
    background: "#eaf8f5",
    iconBackground: "#d7f3ed",
  },

  "الأدوية الجلدية": {
    background: "#edf9f6",
    iconBackground: "#dcf4ef",
  },

  "الجهاز التنفسي": {
    background: "#eaf9f6",
    iconBackground: "#d8f3ed",
  },
};
