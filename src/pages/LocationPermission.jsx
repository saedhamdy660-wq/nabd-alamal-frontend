...
export default function LocationPermission() {
  ...
  return (
    <div className="page" style={{ paddingTop: 30, textAlign: "center" }}>
      <div style={{ textAlign: "right", marginBottom: 20, fontSize: 20, cursor: "pointer" }} onClick={() => navigate(-1)}>←</div>
      ...
      <p className="muted" style={{ marginBottom: 30, padding: "0 8px" }}>
        تقديم تنبيهات دقيقة ومعرفة أقرب الصيدليات أو المستشفيات إليك
      </p>
